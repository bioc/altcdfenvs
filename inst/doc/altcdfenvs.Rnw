...
Laurent Gautier, Morten M{\o}ller, Lennart Friis-Hansen and
Steen Knudsen. Alternative mapping of probes to genes for
{\it Affymetrix} chips. 2004. BMC Bioinformatics (to appear).
